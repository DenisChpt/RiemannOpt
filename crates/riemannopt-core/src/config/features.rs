...
pub static CPU_FEATURES: LazyLock<Arc<CpuFeatures>> =
	LazyLock::new(|| Arc::new(CpuFeatures::detect()));
...
pub static SIMD_CONFIG: LazyLock<Arc<SimdConfig>> =
	LazyLock::new(|| Arc::new(SimdConfig::default()));
