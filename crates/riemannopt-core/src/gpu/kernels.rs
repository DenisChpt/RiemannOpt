...
pub mod reduction {
	...
	pub fn sum_reduce_f32(input: *const f32, output: *mut f32, n: usize) -> Result<(), GpuError> {
		// Kernel implementation
		Err(GpuError::NotAvailable)
	}

	/// Norm reduction kernel
	pub fn norm_reduce_f32(input: *const f32, output: *mut f32, n: usize) -> Result<(), GpuError> {
		// Kernel implementation
		Err(GpuError::NotAvailable)
	}
